...
object AppInstaller {
    ...
    suspend fun installApk(
        ...
        try {
            ...
            if (expectedChecksum != null) {
                val actualChecksum = com.iips.launcher.utils.SecurityUtils.calculateFileSha256(tempFile)
    ...
    private fun silentInstall(context: Context, apkFile: File, appId: String?, version: String?) {
        ...
        val intent = Intent(context, com.iips.launcher.device.BootReceiver::class.java).apply {
