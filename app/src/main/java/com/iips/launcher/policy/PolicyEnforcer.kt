...
object PolicyEnforcer {
    ...
    suspend fun enforcePolicy(context: Context, snapshot: com.iips.launcher.network.models.DevicePolicySnapshot) = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            if (snapshot.kioskMode) {
                com.iips.launcher.policy.KioskController.applyPolicy(context)
            }
            ...
            if (snapshot.settingsLock) {
                ...
                com.iips.launcher.policy.DeviceController.blockSettingsAccess(context, true)
            } else {
                com.iips.launcher.policy.DeviceController.blockSettingsAccess(context, false)
            }
